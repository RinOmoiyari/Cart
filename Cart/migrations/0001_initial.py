# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-19 17:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_by', models.CharField(blank=True, max_length=50)),
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('fk_flow', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Cart.Flows')),
            ],
        ),
        migrations.CreateModel(
            name='TaskTemplates',
            fields=[
                ...
                ('fk_flow', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Cart.Flows')),
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Cart.Roles')),
            ],
        ),
        migrations.CreateModel(
            name='WorkRequests',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Cart.TaskTemplates'),
        ),
        migrations.AddField(
            model_name='tasks',
            name='fk_work_req',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Cart.WorkRequests'),
        ),
        migrations.AddField(
            model_name='tasks',
            name='role',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Cart.Roles'),
        ),
    ]
